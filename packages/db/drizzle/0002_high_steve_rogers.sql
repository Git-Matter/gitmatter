...
CREATE INDEX "passkey_user_id_idx" ON "auth"."passkey" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "passkey_credential_id_idx" ON "auth"."passkey" USING btree ("credential_id");